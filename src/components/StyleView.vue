...
onMounted(() => {
  form.headlineFont = cardStyles.value.titleFont;
  form.headlineWeight = cardStyles.value.titleWeight;
  form.contentFont = cardStyles.value.contentFont;
  form.contentWeight = cardStyles.value.contentWeight;
  form.textColor = cardStyles.value.textColor;
  form.borderColor = cardStyles.value.borderColor;
  form.contentFontSize = cardStyles.value.contentFontSize;
  form.headlineFontSize = cardStyles.value.titleFontSize;
  form.mostPopularBorderColor = cardStyles.value.popularBorderColor;
  form.mostPopularBgColor = cardStyles.value.popularBgColor;
  form.mostPopularLabelColor = cardStyles.value.popularLabelColor;
  form.annualPriceColor = cardStyles.value.secondaryTextColor;
  form.buttonBgColor = cardStyles.value.buttonBgColor;
  form.mostPopularButtonBgColor = cardStyles.value.buttonBgColor;
  form.featureUnavailableColor = cardStyles.value.secondaryTextColor;
});
</script>
