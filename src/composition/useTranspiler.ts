...
export const useTranspiler = () => {
  ...
  const icons = {
    ...
    email: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M424 80H88a56.06 56.06 0 0 0-56 56v240a56.06 56.06 0 0 0 56 56h336a56.06 56.06 0 0 0 56-56V136a56.06 56.06 0 0 0-56-56zm-14.18 92.63l-144 112a16 16 0 0 1-19.64 0l-144-112a16 16 0 1 1 19.64-25.26L256 251.73l134.18-104.36a16 16 0 0 1 19.64 25.26z" fill="currentColor"></path></svg>`,
    website: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208 208-93.13 208-208S370.87 48 256 48zm101.94 82.12A176.07 176.07 0 0 1 409.44 192H334.7a331.91 331.91 0 0 0-25.33-61.88 199.57 199.57 0 0 1 48.57 0zM334.48 224h74.08a175.25 175.25 0 0 1 0 64h-74.08a330.26 330.26 0 0 0 0-64zm-45.26 96A199.45 199.45 0 0 1 256 376.54A199.45 199.45 0 0 1 222.78 320zm0-128A199.45 199.45 0 0 1 256 135.46A199.45 199.45 0 0 1 289.22 192zM177.52 224A330.26 330.26 0 0 0 177.52 288H103.44a175.25 175.25 0 0 1 0-64zM256 80a175.48 175.48 0 0 1 25.2 1.8c-15.5 12.3-29.6 35.4-40.2 66.2-10.6-30.8-24.7-53.9-40.2-66.2A175.48 175.48 0 0 1 256 80zm-45.94 50.12A199.57 199.57 0 0 1 202.63 130.12a331.91 331.91 0 0 0-25.33 61.88H102.56a176.07 176.07 0 0 1 51.5-61.88zM102.56 320h74.74a331.91 331.91 0 0 0 25.33 61.88 199.57 199.57 0 0 1-48.57 0A176.07 176.07 0 0 1 102.56 320zm153.44 112a175.48 175.48 0 0 1-25.2-1.8c15.5-12.3 29.6-35.4 40.2-66.2 10.6 30.8 24.7 53.9 40.2 66.2A175.48 175.48 0 0 1 256 432zm101.94-50.12a199.57 199.57 0 0 1 7.43 0 331.91 331.91 0 0 0 25.33-61.88h74.74a176.07 176.07 0 0 1-51.5 61.88z" fill="currentColor"></path></svg>`
  };
                ...
                <div class="business-card" onclick="handleBusinessClick('${business.buttonAction || '#'}')">
                  ...
                  <div class="business-content">
                    ...
                    <div class="contact-info">
                      ...
                      ${business.contact?.email && displayOptions.value.showEmail ? `
                        <div class="contact-item">
                          <i role="img" class="n-icon contact-icon">${icons.email}</i>
                          <a href="mailto:${business.contact.email}">${business.contact.email}</a>
                        </div>
                      ` : ''}
                      
                      ${business.contact?.website && displayOptions.value.showWebsite ? `
                        <div class="contact-item">
                          <i role="img" class="n-icon contact-icon">${icons.website}</i>
                          <a href="${business.contact.website}" target="_blank" rel="noopener noreferrer">${business.contact.website}</a>
                        </div>
                      ` : ''}
